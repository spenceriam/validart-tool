...
```bash
git remote add encore encore://validart-tool-gbmi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/validart-tool-gbmi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/validart-tool-gbmi/settings/integrations/github)
