 ...
 */
export class Client {
    public readonly validart: validart.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.validart = new validart.ServiceClient(base)
    }
 ...
 */
import { health as api_validart_health_health } from "~backend/validart/health";
import {
    getDownloadUrl as api_validart_upload_getDownloadUrl,
    getUploadUrl as api_validart_upload_getUploadUrl
} from "~backend/validart/upload";

export namespace validart {
    ...
    export class ServiceClient {
         ...
         */
        public async getDownloadUrl(params: RequestType<typeof api_validart_upload_getDownloadUrl>): Promise<ResponseType<typeof api_validart_upload_getDownloadUrl>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/download/url`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_validart_upload_getDownloadUrl>
        }

        /**
         * Generate a signed upload URL for artwork files
         */
        public async getUploadUrl(params: RequestType<typeof api_validart_upload_getUploadUrl>): Promise<ResponseType<typeof api_validart_upload_getUploadUrl>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/upload/url`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_validart_upload_getUploadUrl>
        }

        /**
         * Health check endpoint for the service
         */
        public async health(): Promise<ResponseType<typeof api_validart_health_health>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/health`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_validart_health_health>
        }
    }
}
